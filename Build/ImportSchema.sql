DELETE FROM be_users WHERE email = '_cli_phpunit@example.com';
...
delimiter ;;
create procedure jcdbstcybdsucytkdyeuwyclsybustdbcuydgs ()
begin
...
call jcdbstcybdsucytkdyeuwyclsybustdbcuydgs();;
