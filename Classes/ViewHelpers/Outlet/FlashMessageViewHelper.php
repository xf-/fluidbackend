 ...
 */
class Tx_Fluidbackend_ViewHelpers_Outlet_FlashMessageViewHelper extends Tx_Fluidbackend_ViewHelpers_Outlet_AbstractOutletViewHelper {
	...
	public function initializeArguments() {
		...
		$this->registerArgument('severity', 'integer', 'Optional severity / log level - defaults to t3lib_FlashMessage::OK', FALSE, t3lib_FlashMessage::OK);
